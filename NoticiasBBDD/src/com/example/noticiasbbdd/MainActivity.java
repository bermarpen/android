...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buscar=(Button)findViewById(R.id.botobuscar);
		Button vernoticia=(Button)findViewById(R.id.visualitzanoticia);
		text=(TextView)findViewById(R.id.noticia);
		conectar=new ConexioBBDD(this,"DBNoticias",null,1);
		...
		vernoticia.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent i= new Intent(MainActivity.this,VisualitzaNoticies.class);
				startActivity(i);
			}
		});
	}		
			...
			if(conexion.getResponseCode() == HttpURLConnection.HTTP_OK){
				...
				while(lectura!=null){
					if(lectura.indexOf("<title>")>=0){
						...
						//Envia datos a la BD
						database.execSQL("INSERT INTO Guardarnoticies (noticia) values ('"+lectura.substring(i,j)+"')");
						salida+="\n**************\n";
					}
