...
public class VisualitzaCentres extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_visualitza_centres);
		
		Button guardar = (Button)findViewById(R.id.guardarCentre);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.visualitza_centre, menu);
		return true;
	}
